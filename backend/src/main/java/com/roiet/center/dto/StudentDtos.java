...
public final class StudentDtos {
 ...
 public record Summary(Long id,String name,String phone,Student.Status status,String memo,Long currentTeamId,String currentTeamName,Double attendanceRate,LocalDate latestAttendanceDate){
  public Summary(Long id,String name,String phone,Student.Status status,String memo,Long currentTeamId,String currentTeamName){this(id,name,phone,status,memo,currentTeamId,currentTeamName,null,null);}
 }
