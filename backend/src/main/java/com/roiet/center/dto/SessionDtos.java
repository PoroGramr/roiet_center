...
public final class SessionDtos {
 private SessionDtos(){}
 public record CreateRequest(@NotNull Long teamId,@NotNull LocalDate sessionDate,LocalTime startTime,LocalTime endTime,@Size(max=150) String title,@NotBlank @Size(max=4000) String content,@Size(max=2000) String memo,@Valid @NotEmpty List<AttendanceDtos.Input> attendances){}
